                    ...
                    if (task.isSuccessful) {
                        ...
                        firestore.collection("profiles")
                            ...
                            .addOnSuccessListener {
                                result("Account created successfully", true,profileImageUrl)
                            }
                            .addOnFailureListener { e ->
                                result("Account created, but data upload failed", false,null)
                            }
                    } else {
                        result(task.exception!!.message.toString(), false,null)
                    }
                }
        } catch (e: Exception) {
            result("Failed to create account: ${e.message}", false,null)
        }
    }
